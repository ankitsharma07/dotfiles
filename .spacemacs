  ...
  (setq-default
   ...
   '(
     ...
     (colors :variables
             ...
             nyan-stop-animation t
             nyan-number-of-rainbows 3
             nyan-wavy-trail nil
             )
   ...
   dotspacemacs-additional-packages '(diff-hl
                                      cloc
                                      eglot
                                      pomidor
                                      key-quiz
...
before packages are loaded."
   ...
   ;; Org mode settings
  (setq org-directory "/Users/ankitsharma/Dropbox/org/")
  ...
  (setq org-todo-keywords
        '((sequence "TODO(t)" "IN-PROGRESS(i)" "WAITING(w@/!)" "PAUSE(p)" "SOMEDAY(s)" "NEXT(n)" "|" "DONE(d!)" "CANCELLED(c@)")
          (sequence "[ ](T)" "[-](P)" "[?](m)" "|" "[X](D)")))

  (setq org-todo-keyword-faces
        '(("TODO" . "#f27367")("IN-PROGRESS" . "#ebebeb") ("WAITING" . "#B498F5") ("PAUSE" . "#0EFFB9") ("SOMEDAY" . "#6BFFFB") ("CANCELLED" . "#F52130") ("DONE" . "#81FFC0"))
        )
